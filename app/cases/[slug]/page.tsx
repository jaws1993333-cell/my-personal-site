          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.36fr] lg:items-start">
            <div className="rounded-[2rem] border border-stone-200 bg-white/88 p-6 shadow-sm shadow-slate-900/5 sm:p-9">
              ...
              <section className="mt-8 rounded-[1.5rem] bg-[#f8f4ec] p-5 sm:p-6">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {item.features.map((feature) => (
                    <span key={feature} className="rounded-full bg-white px-4 py-2 text-sm text-slate-700 shadow-sm shadow-slate-900/5">
                      {feature}
                    </span>
                  ))}
                </div>
              ...
              <div className="mt-10 rounded-[1.5rem] bg-emerald-50 p-5 sm:p-6">
                <p className="text-xl font-semibold text-slate-950">你也在准备类似项目？</p>
